          ...
          <div className="space-y-12">
            ...
            <div className="flex">
              <div className="w-32 flex-shrink-0">
                <span className="text-gray-600">Jun 2024 - Present</span>
              </div>
            ...
            <div className="flex">
              ...
              <div className="border-l-2 border-blue-600 pl-8 pb-8">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Figma</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Social Media Marketing</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="border-l-2 border-blue-600 pl-8 pb-8">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Sound and Audio Equipment</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="border-l-2 border-blue-600 pl-8 pb-8">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Event Management</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Community Building</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Tournament Organization</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="border-l-2 border-blue-600 pl-8">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Strategic Analysis</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Tournament Play</span>
                </div>
              </div>
            </div>
          </div>
